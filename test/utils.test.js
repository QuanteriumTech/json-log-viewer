...
describe('hasColors', () => {
  it('is false for string with no colors', () => {
    expect(hasColors('res')).to.be.false // eslint-disable-line
  })

  it('is true for string with colors', () => {
    expect(hasColors('{bold}res{/bold}')).to.be.true // eslint-disable-line
  })
})
